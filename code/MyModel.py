...
class FeatureReduction(nn.Module):
    def __init__(self, inputFeature, outputFeature):
        ...
        self.outFeature = outputFeature
        self.c1 = nn.Linear(inputFeature, inputFeature//2)
        self.c2 = nn.Linear(inputFeature//2, outputFeature)
        self.relu = nn.ReLU()
...
if __name__ == '__main__':
    resnet_18 = resnet18()
    sample = torch.randn(2,15,256, 256)
    x = resnet_18(sample)
    cls_h = cls_head()
    predicted = cls_h(x)
